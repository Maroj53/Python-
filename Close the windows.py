...
WindowWidth = 40                       #- Set the width of the game window
WindowHeight = 40                       #- Set the height of the game window
...
#- Prepare the timer
Clock = pygame.time.Clock()                #- Initialize the timing mdodule
...
class Players:
  def __init__(self, centerY, centerX, WalkSpeed, size, Health):
    ...
    self.Surface3 = pygame.Surface([self.size, self.size], pygame.SRCALPHA, 32)  #- Create surface for the player
    self.Surface3.fill([200, 200, 200])  #- Fill the player with a color
