...
class spinner:
    ...
    def rotate_png(self):
        ...
        self.rotated_image = self.rotated_spinner.convert_alpha()    
...
spinner1 = spinner(20, 20, 3, 2, spinner_surface)
...
while main_loop:
    ...
    def spin(i):
        ...
        window.blit(spinner1.rotated_image, [spinner1.center_x - 100, spinner1.center_y - 100]) 
